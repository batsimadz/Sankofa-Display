 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, coptic, tifinagh, tai-le, canadian-aboriginal, math, old-permic, malayalam
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: tai-viet, masaram-gondi, miao, music, adlam, gurmukhi, cham, syriac, batak, newa, marchen, buginese, syloti-nagri, sharada, javanese, old-permic, pahawh-hmong, gunjala-gondi, tagalog, tagbanwa, zanabazar-square, mandaic, khudawadi, math, gujarati, devanagari, osage, takri, limbu, ahom, rejang, sundanese, yi, meetei-mayek, new-tai-lue, coptic, bengali, psalter-pahlavi, myanmar, khmer, caucasian-albanian, grantha, kharoshthi, oriya, tifinagh, kaithi, sogdian, modi, mende-kikakui, phags-pa, lepcha, sinhala, kannada, tirhuta, balinese, wancho, duployan, mahajani, chakma, symbols, hebrew, brahmi, malayalam, telugu, tamil, khojki, kayah-li, nko, hanunoo, lao, hanifi-rohingya, thai, bassa-vah, bhaiksuki, tibetan, tai-le, elbasan, soyombo, dogra, manichaean, thaana, buhid, siddham, mongolian
...
Your font fully covers the following languages that require the soft-dotted feature: Avokaya (Latn, 100,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Lugbara (Latn, 2,200,000 speakers), Ejagham (Latn, 120,000 speakers), Navajo (Latn, 166,319 speakers), Dutch (Latn, 31,709,104 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Aghem (Latn, 38,843 speakers), Basaa (Latn, 332,940 speakers), Nateni (Latn, 100,000 speakers), Dan (Latn, 1,099,244 speakers), Kom (Latn, 360,685 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Koonzime (Latn, 40,000 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

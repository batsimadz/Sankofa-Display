 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, tifinagh, math, syriac, coptic, malayalam, canadian-aboriginal, old-permic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: psalter-pahlavi, sogdian, limbu, telugu, hebrew, masaram-gondi, tamil, bassa-vah, rejang, thai, dogra, adlam, duployan, phags-pa, kayah-li, miao, brahmi, syloti-nagri, kharoshthi, mahajani, math, kannada, yi, wancho, buhid, gujarati, chakma, sinhala, tifinagh, mandaic, khudawadi, hanunoo, batak, devanagari, tagalog, manichaean, takri, soyombo, buginese, gurmukhi, mongolian, sundanese, symbols, ahom, new-tai-lue, hanifi-rohingya, myanmar, kaithi, lepcha, siddham, osage, tirhuta, javanese, zanabazar-square, grantha, lao, tibetan, syriac, khmer, newa, old-permic, pahawh-hmong, tai-le, mende-kikakui, oriya, gunjala-gondi, caucasian-albanian, bhaiksuki, meetei-mayek, sharada, tagbanwa, coptic, nko, balinese, cham, marchen, elbasan, tai-viet, thaana, music, modi, bengali, khojki, malayalam
...
Your font fully covers the following languages that require the soft-dotted feature: Southern Kisi (Latn, 360,000 speakers), Ebira (Latn, 2,200,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Avokaya (Latn, 100,000 speakers), Cicipu (Latn, 44,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Fur (Latn, 1,230,163 speakers), Zapotec (Latn, 490,000 speakers), Ekpeye (Latn, 226,000 speakers), Nzakara (Latn, 50,000 speakers), Dutch (Latn, 31,709,104 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Koonzime (Latn, 40,000 speakers), Mango (Latn, 77,000 speakers), Mundani (Latn, 34,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Sar (Latn, 500,000 speakers), Dii (Latn, 71,000 speakers), South Central Banda (Latn, 244,000 speakers), Ejagham (Latn, 120,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Mfumte (Latn, 79,000 speakers), Yala (Latn, 200,000 speakers), Bafut (Latn, 158,146 speakers), Belarusian (Cyrl, 10,064,517 speakers), Nateni (Latn, 100,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Makaa (Latn, 221,000 speakers), Aghem (Latn, 38,843 speakers), Kom (Latn, 360,685 speakers), Gulay (Latn, 250,478 speakers), Basaa (Latn, 332,940 speakers). [code: soft-dotted]

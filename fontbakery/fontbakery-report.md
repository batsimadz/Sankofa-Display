 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, syriac, canadian-aboriginal, tifinagh, old-permic, tai-le, coptic, malayalam
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: math, gurmukhi, khojki, tirhuta, balinese, soyombo, lao, thai, limbu, mongolian, ahom, coptic, bengali, takri, tibetan, modi, rejang, sinhala, kannada, tagbanwa, mende-kikakui, syloti-nagri, hanifi-rohingya, wancho, newa, kharoshthi, hebrew, sundanese, yi, buhid, myanmar, malayalam, kaithi, gunjala-gondi, thaana, oriya, dogra, gujarati, sharada, hanunoo, mandaic, batak, cham, bassa-vah, old-permic, pahawh-hmong, zanabazar-square, tai-viet, siddham, elbasan, tagalog, bhaiksuki, phags-pa, grantha, new-tai-lue, mahajani, telugu, manichaean, devanagari, duployan, marchen, adlam, psalter-pahlavi, khmer, tamil, syriac, caucasian-albanian, tifinagh, osage, tai-le, lepcha, meetei-mayek, music, sogdian, kayah-li, buginese, masaram-gondi, symbols, brahmi, khudawadi, javanese, nko, chakma, miao
...
Your font fully covers the following languages that require the soft-dotted feature: Navajo (Latn, 166,319 speakers), Igbo (Latn, 27,823,640 speakers), Lithuanian (Latn, 2,357,094 speakers), Ekpeye (Latn, 226,000 speakers), Cicipu (Latn, 44,000 speakers), Ebira (Latn, 2,200,000 speakers), Fur (Latn, 1,230,163 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Lugbara (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers), Zapotec (Latn, 490,000 speakers), Southern Kisi (Latn, 360,000 speakers), Avokaya (Latn, 100,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Dutch (Latn, 31,709,104 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Mfumte (Latn, 79,000 speakers), Basaa (Latn, 332,940 speakers), South Central Banda (Latn, 244,000 speakers), Aghem (Latn, 38,843 speakers), Ejagham (Latn, 120,000 speakers), Makaa (Latn, 221,000 speakers), Mango (Latn, 77,000 speakers), Dii (Latn, 71,000 speakers), Gulay (Latn, 250,478 speakers), Ngbaka (Latn, 1,020,000 speakers), Koonzime (Latn, 40,000 speakers), Mundani (Latn, 34,000 speakers), Sar (Latn, 500,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dan (Latn, 1,099,244 speakers), Nateni (Latn, 100,000 speakers), Bafut (Latn, 158,146 speakers), Yala (Latn, 200,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Kom (Latn, 360,685 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

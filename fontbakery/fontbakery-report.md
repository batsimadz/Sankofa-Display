...
<details><summary><b>[16] SankofaDisplay-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check font follows the Google Fonts vertical metric schema (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/vertical_metrics">com.google.fonts/check/vertical_metrics</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, tifinagh, old-permic, canadian-aboriginal, tai-le, math, coptic, malayalam
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: buginese, old-permic, osage, limbu, brahmi, math, soyombo, miao, sogdian, bassa-vah, mende-kikakui, tirhuta, wancho, kaithi, takri, mandaic, bhaiksuki, elbasan, siddham, kharoshthi, tai-viet, khudawadi, marchen, dogra, newa, gurmukhi, duployan, ahom, lepcha, zanabazar-square, hebrew, pahawh-hmong, symbols, masaram-gondi, adlam, new-tai-lue, meetei-mayek, kannada, syloti-nagri, mahajani, khojki, bengali, nko, sharada, cham, syriac, oriya, modi, javanese, music, caucasian-albanian, tamil, sinhala, grantha, tai-le, rejang, thaana, yi, buhid, gujarati, batak, devanagari, psalter-pahlavi, khmer, balinese, mongolian, manichaean, telugu, coptic, sundanese, lao, thai, gunjala-gondi, phags-pa, kayah-li, hanifi-rohingya, malayalam, myanmar, hanunoo, tifinagh, tagbanwa, tagalog, tibetan, chakma
...
Your font fully covers the following languages that require the soft-dotted feature: Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Ejagham (Latn, 120,000 speakers), Lugbara (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Ma’di (Latn, 584,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Avokaya (Latn, 100,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Nateni (Latn, 100,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Koonzime (Latn, 40,000 speakers), Dan (Latn, 1,099,244 speakers), Kom (Latn, 360,685 speakers), Belarusian (Cyrl, 10,064,517 speakers), Aghem (Latn, 38,843 speakers), Basaa (Latn, 332,940 speakers). [code: soft-dotted]

...
"copyright 2023 sankofa display (https://github.com/batsimadz/sankofa)"
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, old-permic, coptic, tifinagh, math, canadian-aboriginal, tai-le, syriac
...
Your font does *not* cover the following languages that require the soft-dotted feature: Nateni (Latn, 100,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Dutch (Latn, 31,709,104 speakers), Dan (Latn, 1,099,244 speakers), Koonzime (Latn, 40,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ma’di (Latn, 584,000 speakers), Navajo (Latn, 166,319 speakers), Lugbara (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Basaa (Latn, 332,940 speakers), Aghem (Latn, 38,843 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ejagham (Latn, 120,000 speakers), Ebira (Latn, 2,200,000 speakers), Kom (Latn, 360,685 speakers). [code: soft-dotted]

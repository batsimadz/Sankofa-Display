 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, malayalam, old-permic, syriac, tai-le, coptic, canadian-aboriginal, tifinagh
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: brahmi, music, oriya, gunjala-gondi, sogdian, ahom, bhaiksuki, masaram-gondi, new-tai-lue, khojki, javanese, caucasian-albanian, cham, khudawadi, bengali, gujarati, kharoshthi, phags-pa, syloti-nagri, syriac, psalter-pahlavi, lao, marchen, duployan, grantha, modi, symbols, kaithi, takri, siddham, tagalog, thaana, bassa-vah, math, mandaic, sinhala, mende-kikakui, chakma, tirhuta, meetei-mayek, malayalam, tai-le, thai, kannada, sharada, yi, kayah-li, nko, manichaean, balinese, old-permic, adlam, tifinagh, mongolian, tai-viet, miao, tamil, sundanese, osage, wancho, pahawh-hmong, devanagari, lepcha, khmer, elbasan, limbu, tibetan, batak, mahajani, zanabazar-square, buhid, buginese, newa, dogra, gurmukhi, hanunoo, hebrew, tagbanwa, soyombo, myanmar, telugu, coptic, rejang, hanifi-rohingya
...
Your font fully covers the following languages that require the soft-dotted feature: Lithuanian (Latn, 2,357,094 speakers), Fur (Latn, 1,230,163 speakers), Avokaya (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Ekpeye (Latn, 226,000 speakers), Cicipu (Latn, 44,000 speakers), Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Southern Kisi (Latn, 360,000 speakers), Zapotec (Latn, 490,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Navajo (Latn, 166,319 speakers), Lugbara (Latn, 2,200,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Gulay (Latn, 250,478 speakers), Aghem (Latn, 38,843 speakers), Dii (Latn, 71,000 speakers), Nateni (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers), Bafut (Latn, 158,146 speakers), Mfumte (Latn, 79,000 speakers), Kom (Latn, 360,685 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Sar (Latn, 500,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), South Central Banda (Latn, 244,000 speakers), Koonzime (Latn, 40,000 speakers), Mundani (Latn, 34,000 speakers), Basaa (Latn, 332,940 speakers), Ngbaka (Latn, 1,020,000 speakers), Dan (Latn, 1,099,244 speakers), Mango (Latn, 77,000 speakers), Yala (Latn, 200,000 speakers), Makaa (Latn, 221,000 speakers). [code: soft-dotted]

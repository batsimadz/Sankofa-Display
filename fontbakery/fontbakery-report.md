 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, old-permic, malayalam, canadian-aboriginal, tifinagh, coptic, tai-le, syriac
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: newa, gunjala-gondi, javanese, osage, mandaic, brahmi, khmer, pahawh-hmong, masaram-gondi, thaana, kharoshthi, zanabazar-square, adlam, sogdian, bassa-vah, music, buhid, oriya, hanunoo, limbu, bhaiksuki, mongolian, balinese, buginese, tifinagh, syriac, hebrew, batak, syloti-nagri, phags-pa, tamil, new-tai-lue, lepcha, caucasian-albanian, gujarati, lao, tibetan, tirhuta, tai-le, tagbanwa, gurmukhi, devanagari, psalter-pahlavi, modi, wancho, kannada, sinhala, kayah-li, mende-kikakui, khudawadi, manichaean, marchen, grantha, rejang, tai-viet, sharada, bengali, symbols, khojki, old-permic, chakma, takri, kaithi, siddham, soyombo, nko, malayalam, thai, cham, ahom, math, meetei-mayek, myanmar, tagalog, telugu, coptic, yi, dogra, sundanese, elbasan, mahajani, hanifi-rohingya, miao, duployan
...
Your font fully covers the following languages that require the soft-dotted feature: Avokaya (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers), Dutch (Latn, 31,709,104 speakers), Nzakara (Latn, 50,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Cicipu (Latn, 44,000 speakers), Southern Kisi (Latn, 360,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ekpeye (Latn, 226,000 speakers), Lugbara (Latn, 2,200,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Zapotec (Latn, 490,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Koonzime (Latn, 40,000 speakers), Bafut (Latn, 158,146 speakers), Yala (Latn, 200,000 speakers), South Central Banda (Latn, 244,000 speakers), Ejagham (Latn, 120,000 speakers), Basaa (Latn, 332,940 speakers), Makaa (Latn, 221,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Kom (Latn, 360,685 speakers), Dan (Latn, 1,099,244 speakers), Aghem (Latn, 38,843 speakers), Gulay (Latn, 250,478 speakers), Mango (Latn, 77,000 speakers), Sar (Latn, 500,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Nateni (Latn, 100,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mfumte (Latn, 79,000 speakers), Dii (Latn, 71,000 speakers), Mundani (Latn, 34,000 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, tifinagh, canadian-aboriginal, malayalam, coptic, syriac, math, old-permic
 ...
 * U+0331 COMBINING MACRON BELOW: try adding one of: caucasian-albanian, tifinagh, gothic, syriac, cherokee
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: tai-viet, khmer, hanifi-rohingya, javanese, balinese, rejang, symbols, dogra, malayalam, meetei-mayek, mende-kikakui, soyombo, phags-pa, yi, kharoshthi, duployan, ahom, kayah-li, pahawh-hmong, sundanese, bhaiksuki, caucasian-albanian, hebrew, tibetan, siddham, mahajani, bassa-vah, zanabazar-square, kannada, buhid, bengali, devanagari, khudawadi, modi, psalter-pahlavi, tagbanwa, tirhuta, sinhala, gurmukhi, math, mongolian, sogdian, sharada, tai-le, kaithi, tagalog, syloti-nagri, cham, tamil, osage, buginese, old-permic, lao, adlam, gujarati, brahmi, elbasan, manichaean, telugu, marchen, thai, grantha, khojki, batak, wancho, takri, lepcha, nko, miao, limbu, hanunoo, tifinagh, thaana, chakma, masaram-gondi, myanmar, music, oriya, new-tai-lue, coptic, newa, mandaic, gunjala-gondi, syriac
...
Your font fully covers the following languages that require the soft-dotted feature: Ejagham (Latn, 120,000 speakers), Navajo (Latn, 166,319 speakers), Igbo (Latn, 27,823,640 speakers), Ma’di (Latn, 584,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Dutch (Latn, 31,709,104 speakers), Avokaya (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Lugbara (Latn, 2,200,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Aghem (Latn, 38,843 speakers), Dan (Latn, 1,099,244 speakers), Nateni (Latn, 100,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Belarusian (Cyrl, 10,064,517 speakers), Koonzime (Latn, 40,000 speakers), Kom (Latn, 360,685 speakers), Basaa (Latn, 332,940 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, malayalam, tai-le, canadian-aboriginal, math, tifinagh, syriac, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: gujarati, bassa-vah, kannada, saurashtra, tai-viet, masaram-gondi, marchen, music, tibetan, siddham, tagbanwa, zanabazar-square, buginese, nko, canadian-aboriginal, hanifi-rohingya, mahajani, mongolian, bhaiksuki, modi, gunjala-gondi, thaana, symbols, telugu, pahawh-hmong, rejang, lepcha, tifinagh, psalter-pahlavi, khmer, warang-citi, limbu, cham, tai-le, elbasan, sogdian, mandaic, takri, gurmukhi, armenian, yi, devanagari, wancho, sinhala, syloti-nagri, hanunoo, kaithi, math, tirhuta, meetei-mayek, myanmar, hebrew, sundanese, oriya, bengali, tai-tham, phags-pa, chakma, syriac, caucasian-albanian, osage, duployan, balinese, miao, new-tai-lue, kharoshthi, thai, khudawadi, khojki, tagalog, grantha, old-permic, adlam, manichaean, soyombo, lao, buhid, newa, sharada, kayah-li, javanese, tamil, mende-kikakui, batak, malayalam, ahom, dogra, coptic, brahmi
...
Your font fully covers the following languages that require the soft-dotted feature: Bete-Bendi (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Lugbara (Latn, 2,200,000 speakers), Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Avokaya (Latn, 100,000 speakers), Ekpeye (Latn, 226,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Cicipu (Latn, 44,000 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Zapotec (Latn, 490,000 speakers), Nzakara (Latn, 50,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Gulay (Latn, 250,478 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Basaa (Latn, 332,940 speakers), Nateni (Latn, 100,000 speakers), Dan (Latn, 1,099,244 speakers), Makaa (Latn, 221,000 speakers), Mfumte (Latn, 79,000 speakers), Ejagham (Latn, 120,000 speakers), Mundani (Latn, 34,000 speakers), Bafut (Latn, 158,146 speakers), Mango (Latn, 77,000 speakers), South Central Banda (Latn, 244,000 speakers), Kom (Latn, 360,685 speakers), Dii (Latn, 71,000 speakers), Koonzime (Latn, 40,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Southern Kisi (Latn, 360,000 speakers), Aghem (Latn, 38,843 speakers), Yala (Latn, 200,000 speakers), Sar (Latn, 500,000 speakers). [code: soft-dotted]

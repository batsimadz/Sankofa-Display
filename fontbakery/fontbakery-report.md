 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, malayalam, tifinagh, old-permic, canadian-aboriginal, coptic, syriac, tai-le
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: dogra, duployan, khudawadi, tirhuta, old-permic, buginese, sharada, syloti-nagri, hebrew, sundanese, symbols, balinese, batak, grantha, bengali, chakma, soyombo, marchen, kayah-li, limbu, hanifi-rohingya, javanese, miao, takri, phags-pa, khojki, oriya, kharoshthi, thai, malayalam, cham, ahom, gujarati, math, newa, brahmi, meetei-mayek, syriac, thaana, osage, gunjala-gondi, gurmukhi, tagbanwa, music, telugu, mandaic, tagalog, tai-le, mongolian, masaram-gondi, tifinagh, kannada, modi, nko, wancho, yi, sinhala, buhid, lepcha, adlam, devanagari, khmer, zanabazar-square, tai-viet, siddham, manichaean, tamil, hanunoo, tibetan, elbasan, mende-kikakui, pahawh-hmong, rejang, bassa-vah, psalter-pahlavi, mahajani, caucasian-albanian, bhaiksuki, myanmar, new-tai-lue, sogdian, lao, kaithi, coptic
...
Your font fully covers the following languages that require the soft-dotted feature: Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Zapotec (Latn, 490,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Nzakara (Latn, 50,000 speakers), Avokaya (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ekpeye (Latn, 226,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Southern Kisi (Latn, 360,000 speakers), Ebira (Latn, 2,200,000 speakers), Dutch (Latn, 31,709,104 speakers), Cicipu (Latn, 44,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Ukrainian (Cyrl, 29,273,587 speakers), Mfumte (Latn, 79,000 speakers), Nateni (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Koonzime (Latn, 40,000 speakers), Gulay (Latn, 250,478 speakers), Sar (Latn, 500,000 speakers), Dii (Latn, 71,000 speakers), Kom (Latn, 360,685 speakers), South Central Banda (Latn, 244,000 speakers), Mundani (Latn, 34,000 speakers), Aghem (Latn, 38,843 speakers), Belarusian (Cyrl, 10,064,517 speakers), Yala (Latn, 200,000 speakers), Mango (Latn, 77,000 speakers), Basaa (Latn, 332,940 speakers), Ngbaka (Latn, 1,020,000 speakers), Bafut (Latn, 158,146 speakers), Dan (Latn, 1,099,244 speakers), Ejagham (Latn, 120,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers). [code: soft-dotted]

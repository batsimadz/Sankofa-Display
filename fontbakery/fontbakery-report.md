 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, malayalam, tifinagh, syriac, tai-le, canadian-aboriginal, coptic, old-permic
 ...
 * U+0331 COMBINING MACRON BELOW: try adding one of: gothic, cherokee, tifinagh, syriac, caucasian-albanian
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: bhaiksuki, yi, lepcha, osage, kannada, oriya, gunjala-gondi, dogra, psalter-pahlavi, chakma, buginese, malayalam, nko, sundanese, gujarati, wancho, brahmi, kaithi, mende-kikakui, tagalog, khojki, tirhuta, syloti-nagri, pahawh-hmong, batak, telugu, meetei-mayek, sinhala, bengali, siddham, elbasan, khmer, miao, javanese, zanabazar-square, coptic, kharoshthi, ahom, cham, masaram-gondi, takri, marchen, old-permic, rejang, tifinagh, newa, mandaic, tagbanwa, limbu, new-tai-lue, hebrew, thai, devanagari, soyombo, tibetan, tamil, kayah-li, khudawadi, mongolian, thaana, gurmukhi, grantha, phags-pa, buhid, bassa-vah, adlam, mahajani, sogdian, lao, sharada, manichaean, tai-le, balinese, math, myanmar, music, modi, syriac, tai-viet, caucasian-albanian, hanifi-rohingya, symbols, hanunoo, duployan
...
Your font fully covers the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Avokaya (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers), Dutch (Latn, 31,709,104 speakers), Lithuanian (Latn, 2,357,094 speakers), Lugbara (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Ukrainian (Cyrl, 29,273,587 speakers), Kom (Latn, 360,685 speakers), Basaa (Latn, 332,940 speakers), Koonzime (Latn, 40,000 speakers), Aghem (Latn, 38,843 speakers), Belarusian (Cyrl, 10,064,517 speakers), Nateni (Latn, 100,000 speakers), Dan (Latn, 1,099,244 speakers). [code: soft-dotted]

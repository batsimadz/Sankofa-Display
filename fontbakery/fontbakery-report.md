 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, coptic, syriac, malayalam, old-permic, tifinagh, canadian-aboriginal, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: khudawadi, adlam, devanagari, lao, tagbanwa, kannada, javanese, newa, manichaean, math, buginese, miao, syriac, khmer, old-permic, psalter-pahlavi, mandaic, oriya, myanmar, sundanese, new-tai-lue, masaram-gondi, thai, gurmukhi, kaithi, tai-viet, mongolian, wancho, gujarati, music, malayalam, hebrew, sinhala, batak, syloti-nagri, soyombo, duployan, balinese, kharoshthi, mahajani, dogra, siddham, tai-le, gunjala-gondi, bhaiksuki, sogdian, thaana, osage, sharada, kayah-li, limbu, cham, telugu, yi, bengali, chakma, hanifi-rohingya, tibetan, hanunoo, modi, phags-pa, ahom, meetei-mayek, coptic, zanabazar-square, buhid, tifinagh, khojki, bassa-vah, pahawh-hmong, caucasian-albanian, grantha, takri, tamil, elbasan, tagalog, tirhuta, marchen, mende-kikakui, rejang, nko, lepcha, symbols, brahmi
...
Your font fully covers the following languages that require the soft-dotted feature: Lithuanian (Latn, 2,357,094 speakers), Ebira (Latn, 2,200,000 speakers), Dutch (Latn, 31,709,104 speakers), Navajo (Latn, 166,319 speakers), Lugbara (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers), Ejagham (Latn, 120,000 speakers), Igbo (Latn, 27,823,640 speakers), Avokaya (Latn, 100,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Belarusian (Cyrl, 10,064,517 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dan (Latn, 1,099,244 speakers), Koonzime (Latn, 40,000 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers), Basaa (Latn, 332,940 speakers). [code: soft-dotted]

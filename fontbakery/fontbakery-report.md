 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: coptic, old-permic, tai-le, tifinagh, malayalam, canadian-aboriginal, syriac, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: marchen, tirhuta, kayah-li, math, khudawadi, miao, sinhala, malayalam, nko, coptic, soyombo, old-permic, cham, lepcha, kaithi, devanagari, tagalog, masaram-gondi, zanabazar-square, hanifi-rohingya, javanese, phags-pa, tai-le, syloti-nagri, limbu, khmer, duployan, bengali, osage, bassa-vah, telugu, balinese, mende-kikakui, thai, gurmukhi, oriya, mahajani, wancho, new-tai-lue, myanmar, hebrew, newa, tibetan, tifinagh, gujarati, ahom, kharoshthi, grantha, manichaean, music, gunjala-gondi, symbols, dogra, buginese, modi, tamil, batak, caucasian-albanian, tagbanwa, meetei-mayek, hanunoo, pahawh-hmong, tai-viet, sogdian, yi, mongolian, sundanese, lao, chakma, elbasan, brahmi, takri, syriac, siddham, psalter-pahlavi, mandaic, rejang, sharada, thaana, adlam, bhaiksuki, buhid, kannada, khojki
...
Your font fully covers the following languages that require the soft-dotted feature: Lugbara (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers), Ma’di (Latn, 584,000 speakers), Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), Koonzime (Latn, 40,000 speakers), Kom (Latn, 360,685 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Basaa (Latn, 332,940 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: coptic, old-permic, tai-le, tifinagh, canadian-aboriginal, syriac, malayalam, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: khojki, limbu, balinese, oriya, caucasian-albanian, symbols, dogra, ahom, khmer, siddham, tamil, nko, manichaean, tagalog, old-permic, gunjala-gondi, tai-le, lao, armenian, pahawh-hmong, tai-viet, mongolian, tagbanwa, takri, rejang, music, tai-tham, psalter-pahlavi, osage, saurashtra, mende-kikakui, syloti-nagri, meetei-mayek, cham, brahmi, new-tai-lue, kharoshthi, syriac, wancho, phags-pa, gujarati, coptic, myanmar, grantha, bhaiksuki, mandaic, warang-citi, marchen, canadian-aboriginal, buginese, adlam, math, hanifi-rohingya, mahajani, khudawadi, masaram-gondi, telugu, zanabazar-square, sinhala, miao, lepcha, devanagari, sogdian, kannada, hanunoo, duployan, elbasan, chakma, modi, javanese, tirhuta, gurmukhi, newa, batak, kayah-li, buhid, bassa-vah, yi, malayalam, kaithi, bengali, sharada, sundanese, hebrew, thaana, thai, tifinagh, soyombo, tibetan
...
Your font fully covers the following languages that require the soft-dotted feature: Ma’di (Latn, 584,000 speakers), Ekpeye (Latn, 226,000 speakers), Cicipu (Latn, 44,000 speakers), Ebira (Latn, 2,200,000 speakers), Dutch (Latn, 31,709,104 speakers), Navajo (Latn, 166,319 speakers), Zapotec (Latn, 490,000 speakers), Avokaya (Latn, 100,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Nzakara (Latn, 50,000 speakers), Lugbara (Latn, 2,200,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Fur (Latn, 1,230,163 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Sar (Latn, 500,000 speakers), South Central Banda (Latn, 244,000 speakers), Dan (Latn, 1,099,244 speakers), Mfumte (Latn, 79,000 speakers), Aghem (Latn, 38,843 speakers), Bafut (Latn, 158,146 speakers), Mundani (Latn, 34,000 speakers), Yala (Latn, 200,000 speakers), Koonzime (Latn, 40,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Southern Kisi (Latn, 360,000 speakers), Kom (Latn, 360,685 speakers), Ejagham (Latn, 120,000 speakers), Mango (Latn, 77,000 speakers), Dii (Latn, 71,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Makaa (Latn, 221,000 speakers), Basaa (Latn, 332,940 speakers), Nateni (Latn, 100,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Gulay (Latn, 250,478 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, coptic, tai-le, malayalam, math, canadian-aboriginal, tifinagh, syriac
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: khmer, gurmukhi, devanagari, oriya, marchen, sundanese, limbu, siddham, lepcha, music, kaithi, saurashtra, kannada, duployan, old-permic, armenian, kharoshthi, gujarati, mandaic, thaana, malayalam, bassa-vah, tai-tham, telugu, adlam, mende-kikakui, masaram-gondi, sinhala, sharada, sogdian, tifinagh, mahajani, phags-pa, tai-le, nko, osage, wancho, batak, zanabazar-square, meetei-mayek, psalter-pahlavi, javanese, tagbanwa, soyombo, takri, thai, caucasian-albanian, manichaean, pahawh-hmong, canadian-aboriginal, cham, syriac, bhaiksuki, coptic, hanifi-rohingya, mongolian, tai-viet, syloti-nagri, balinese, modi, khudawadi, brahmi, new-tai-lue, miao, khojki, math, lao, buginese, kayah-li, tirhuta, tibetan, tamil, symbols, newa, elbasan, grantha, bengali, dogra, hanunoo, hebrew, yi, myanmar, warang-citi, rejang, gunjala-gondi, chakma, tagalog, buhid, ahom
...
Your font fully covers the following languages that require the soft-dotted feature: Dutch (Latn, 31,709,104 speakers), Fur (Latn, 1,230,163 speakers), Avokaya (Latn, 100,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ma’di (Latn, 584,000 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers), Navajo (Latn, 166,319 speakers), Cicipu (Latn, 44,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Zapotec (Latn, 490,000 speakers), Ekpeye (Latn, 226,000 speakers), Lugbara (Latn, 2,200,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Southern Kisi (Latn, 360,000 speakers), South Central Banda (Latn, 244,000 speakers), Sar (Latn, 500,000 speakers), Kom (Latn, 360,685 speakers), Aghem (Latn, 38,843 speakers), Mango (Latn, 77,000 speakers), Makaa (Latn, 221,000 speakers), Mfumte (Latn, 79,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Koonzime (Latn, 40,000 speakers), Mundani (Latn, 34,000 speakers), Ejagham (Latn, 120,000 speakers), Dii (Latn, 71,000 speakers), Bafut (Latn, 158,146 speakers), Basaa (Latn, 332,940 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Gulay (Latn, 250,478 speakers), Ngbaka (Latn, 1,020,000 speakers), Yala (Latn, 200,000 speakers), Nateni (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

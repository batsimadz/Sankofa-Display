 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, tai-le, coptic, tifinagh, canadian-aboriginal, syriac, malayalam, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: tai-le, myanmar, symbols, cham, music, psalter-pahlavi, zanabazar-square, brahmi, masaram-gondi, soyombo, kayah-li, bengali, newa, khojki, khudawadi, hanunoo, meetei-mayek, coptic, hanifi-rohingya, sinhala, gurmukhi, khmer, sharada, math, chakma, javanese, tai-viet, pahawh-hmong, syriac, batak, adlam, mandaic, yi, kaithi, kannada, new-tai-lue, osage, balinese, devanagari, thaana, kharoshthi, caucasian-albanian, manichaean, tagalog, nko, old-permic, dogra, siddham, phags-pa, bassa-vah, tamil, bhaiksuki, miao, rejang, grantha, mongolian, modi, tibetan, syloti-nagri, mahajani, gunjala-gondi, tagbanwa, lepcha, oriya, takri, duployan, elbasan, mende-kikakui, sundanese, gujarati, telugu, thai, lao, hebrew, sogdian, malayalam, wancho, tirhuta, ahom, buginese, buhid, limbu, tifinagh, marchen
...
Your font fully covers the following languages that require the soft-dotted feature: Avokaya (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Fur (Latn, 1,230,163 speakers), Bete-Bendi (Latn, 100,000 speakers), Ekpeye (Latn, 226,000 speakers), Navajo (Latn, 166,319 speakers), Nzakara (Latn, 50,000 speakers), Southern Kisi (Latn, 360,000 speakers), Dutch (Latn, 31,709,104 speakers), Ma’di (Latn, 584,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Cicipu (Latn, 44,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Zapotec (Latn, 490,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Ngbaka (Latn, 1,020,000 speakers), Dii (Latn, 71,000 speakers), Dan (Latn, 1,099,244 speakers), Ejagham (Latn, 120,000 speakers), South Central Banda (Latn, 244,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mango (Latn, 77,000 speakers), Kom (Latn, 360,685 speakers), Mfumte (Latn, 79,000 speakers), Aghem (Latn, 38,843 speakers), Mundani (Latn, 34,000 speakers), Gulay (Latn, 250,478 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Koonzime (Latn, 40,000 speakers), Basaa (Latn, 332,940 speakers), Yala (Latn, 200,000 speakers), Bafut (Latn, 158,146 speakers), Nateni (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Sar (Latn, 500,000 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

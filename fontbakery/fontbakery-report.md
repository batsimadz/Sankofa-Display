 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, malayalam, old-permic, canadian-aboriginal, tai-le, math, coptic, syriac
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: ahom, oriya, manichaean, tai-le, wancho, myanmar, hebrew, lao, bengali, soyombo, khmer, grantha, takri, mende-kikakui, khudawadi, mahajani, hanunoo, thaana, newa, masaram-gondi, kannada, phags-pa, limbu, caucasian-albanian, devanagari, javanese, math, coptic, bassa-vah, kharoshthi, buhid, kaithi, pahawh-hmong, new-tai-lue, tifinagh, mongolian, symbols, tibetan, gujarati, sharada, kayah-li, malayalam, yi, cham, hanifi-rohingya, sinhala, old-permic, elbasan, syriac, buginese, khojki, lepcha, tagalog, gunjala-gondi, dogra, tai-viet, zanabazar-square, thai, music, osage, balinese, gurmukhi, sundanese, tagbanwa, sogdian, duployan, meetei-mayek, brahmi, nko, chakma, rejang, bhaiksuki, siddham, telugu, batak, psalter-pahlavi, tirhuta, tamil, mandaic, adlam, miao, modi, syloti-nagri, marchen
...
Your font fully covers the following languages that require the soft-dotted feature: Fur (Latn, 1,230,163 speakers), Igbo (Latn, 27,823,640 speakers), Lithuanian (Latn, 2,357,094 speakers), Southern Kisi (Latn, 360,000 speakers), Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers), Ekpeye (Latn, 226,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Avokaya (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Zapotec (Latn, 490,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Navajo (Latn, 166,319 speakers), Cicipu (Latn, 44,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Mundani (Latn, 34,000 speakers), Basaa (Latn, 332,940 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Gulay (Latn, 250,478 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mango (Latn, 77,000 speakers), Dan (Latn, 1,099,244 speakers), Ejagham (Latn, 120,000 speakers), Nateni (Latn, 100,000 speakers), Bafut (Latn, 158,146 speakers), Yala (Latn, 200,000 speakers), South Central Banda (Latn, 244,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Sar (Latn, 500,000 speakers), Kom (Latn, 360,685 speakers), Belarusian (Cyrl, 10,064,517 speakers), Makaa (Latn, 221,000 speakers), Koonzime (Latn, 40,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Dii (Latn, 71,000 speakers). [code: soft-dotted]

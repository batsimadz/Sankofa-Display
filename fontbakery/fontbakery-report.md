 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, old-permic, tifinagh, coptic, math, syriac, malayalam, canadian-aboriginal
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: tibetan, symbols, telugu, kaithi, devanagari, siddham, grantha, mahajani, marchen, gurmukhi, khudawadi, tagalog, tagbanwa, mende-kikakui, bhaiksuki, old-permic, mongolian, miao, new-tai-lue, rejang, syloti-nagri, myanmar, tamil, sogdian, mandaic, sundanese, coptic, zanabazar-square, buginese, thaana, tai-viet, kharoshthi, music, bassa-vah, syriac, thai, sinhala, ahom, balinese, khojki, meetei-mayek, tirhuta, hebrew, osage, psalter-pahlavi, khmer, gujarati, oriya, malayalam, math, hanunoo, tai-le, phags-pa, manichaean, soyombo, buhid, limbu, dogra, cham, caucasian-albanian, yi, gunjala-gondi, newa, lepcha, nko, takri, adlam, lao, batak, elbasan, modi, kannada, chakma, sharada, brahmi, duployan, wancho, pahawh-hmong, javanese, hanifi-rohingya, kayah-li, masaram-gondi, tifinagh, bengali
...
Your font fully covers the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers), Dutch (Latn, 31,709,104 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Cicipu (Latn, 44,000 speakers), Ma’di (Latn, 584,000 speakers), Fur (Latn, 1,230,163 speakers), Southern Kisi (Latn, 360,000 speakers), Lugbara (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Bete-Bendi (Latn, 100,000 speakers), Avokaya (Latn, 100,000 speakers), Zapotec (Latn, 490,000 speakers), Ekpeye (Latn, 226,000 speakers), Igbo (Latn, 27,823,640 speakers), Lithuanian (Latn, 2,357,094 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Yala (Latn, 200,000 speakers), Kom (Latn, 360,685 speakers), Dan (Latn, 1,099,244 speakers), Sar (Latn, 500,000 speakers), Koonzime (Latn, 40,000 speakers), South Central Banda (Latn, 244,000 speakers), Bafut (Latn, 158,146 speakers), Ngbaka (Latn, 1,020,000 speakers), Makaa (Latn, 221,000 speakers), Dii (Latn, 71,000 speakers), Basaa (Latn, 332,940 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ejagham (Latn, 120,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Nateni (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Mundani (Latn, 34,000 speakers), Mango (Latn, 77,000 speakers). [code: soft-dotted]

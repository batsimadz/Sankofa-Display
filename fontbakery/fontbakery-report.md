 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, coptic, tifinagh, canadian-aboriginal, tai-le, math, malayalam, old-permic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: rejang, khmer, myanmar, masaram-gondi, music, duployan, dogra, miao, kayah-li, mongolian, math, caucasian-albanian, newa, chakma, oriya, sinhala, cham, javanese, tagalog, sogdian, hebrew, telugu, mende-kikakui, batak, malayalam, ahom, modi, bhaiksuki, kannada, meetei-mayek, tagbanwa, thai, symbols, limbu, takri, brahmi, adlam, bassa-vah, manichaean, osage, elbasan, balinese, new-tai-lue, gurmukhi, old-permic, gunjala-gondi, syriac, devanagari, bengali, kaithi, siddham, yi, buginese, lepcha, sharada, mandaic, psalter-pahlavi, khudawadi, mahajani, syloti-nagri, thaana, soyombo, coptic, gujarati, kharoshthi, tai-viet, buhid, tifinagh, nko, phags-pa, grantha, hanunoo, lao, hanifi-rohingya, tamil, tibetan, pahawh-hmong, marchen, sundanese, tai-le, wancho, tirhuta, khojki, zanabazar-square
...
Your font fully covers the following languages that require the soft-dotted feature: Ma’di (Latn, 584,000 speakers), Igbo (Latn, 27,823,640 speakers), Fur (Latn, 1,230,163 speakers), Lugbara (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Lithuanian (Latn, 2,357,094 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Zapotec (Latn, 490,000 speakers), Southern Kisi (Latn, 360,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Dutch (Latn, 31,709,104 speakers), Nzakara (Latn, 50,000 speakers), Ebira (Latn, 2,200,000 speakers), Cicipu (Latn, 44,000 speakers), Ekpeye (Latn, 226,000 speakers), Avokaya (Latn, 100,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Kom (Latn, 360,685 speakers), Bafut (Latn, 158,146 speakers), Aghem (Latn, 38,843 speakers), Ejagham (Latn, 120,000 speakers), Gulay (Latn, 250,478 speakers), Dii (Latn, 71,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Nateni (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers), Sar (Latn, 500,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mundani (Latn, 34,000 speakers), South Central Banda (Latn, 244,000 speakers), Dan (Latn, 1,099,244 speakers), Mfumte (Latn, 79,000 speakers), Basaa (Latn, 332,940 speakers), Makaa (Latn, 221,000 speakers), Yala (Latn, 200,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Koonzime (Latn, 40,000 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, coptic, tai-le, old-permic, canadian-aboriginal, syriac, tifinagh, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: bengali, coptic, gunjala-gondi, tagbanwa, kharoshthi, sinhala, malayalam, psalter-pahlavi, sharada, pahawh-hmong, bassa-vah, khmer, osage, tai-le, hanifi-rohingya, sogdian, tamil, manichaean, miao, marchen, ahom, rejang, gujarati, yi, bhaiksuki, telugu, soyombo, tifinagh, thaana, new-tai-lue, tai-viet, meetei-mayek, buginese, mahajani, siddham, masaram-gondi, lao, dogra, takri, adlam, mende-kikakui, syriac, chakma, tagalog, devanagari, old-permic, kannada, gurmukhi, duployan, lepcha, khojki, kaithi, tirhuta, mandaic, hanunoo, thai, phags-pa, buhid, limbu, newa, javanese, wancho, math, symbols, khudawadi, tibetan, syloti-nagri, modi, balinese, mongolian, music, oriya, batak, cham, zanabazar-square, hebrew, elbasan, kayah-li, sundanese, grantha, brahmi, caucasian-albanian, myanmar, nko
...
Your font fully covers the following languages that require the soft-dotted feature: Dutch (Latn, 31,709,104 speakers), Zapotec (Latn, 490,000 speakers), Southern Kisi (Latn, 360,000 speakers), Avokaya (Latn, 100,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Bete-Bendi (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers), Ekpeye (Latn, 226,000 speakers), Fur (Latn, 1,230,163 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Igbo (Latn, 27,823,640 speakers), Cicipu (Latn, 44,000 speakers), Lugbara (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Kom (Latn, 360,685 speakers), South Central Banda (Latn, 244,000 speakers), Mfumte (Latn, 79,000 speakers), Dii (Latn, 71,000 speakers), Koonzime (Latn, 40,000 speakers), Dan (Latn, 1,099,244 speakers), Yala (Latn, 200,000 speakers), Basaa (Latn, 332,940 speakers), Makaa (Latn, 221,000 speakers), Sar (Latn, 500,000 speakers), Mundani (Latn, 34,000 speakers), Ejagham (Latn, 120,000 speakers), Nateni (Latn, 100,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mango (Latn, 77,000 speakers), Gulay (Latn, 250,478 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ngbaka (Latn, 1,020,000 speakers), Aghem (Latn, 38,843 speakers), Bafut (Latn, 158,146 speakers). [code: soft-dotted]

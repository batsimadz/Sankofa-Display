 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, old-permic, malayalam, canadian-aboriginal, math, tifinagh, syriac, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: masaram-gondi, manichaean, lao, lepcha, dogra, khojki, gurmukhi, cham, buhid, rejang, myanmar, khmer, buginese, batak, adlam, hebrew, bhaiksuki, oriya, kaithi, newa, syriac, tamil, ahom, pahawh-hmong, tirhuta, tai-viet, thai, marchen, bengali, music, elbasan, tagbanwa, sharada, takri, modi, wancho, yi, gunjala-gondi, tifinagh, thaana, kharoshthi, khudawadi, javanese, tibetan, osage, hanifi-rohingya, syloti-nagri, tai-le, gujarati, mahajani, devanagari, kannada, zanabazar-square, mende-kikakui, grantha, sinhala, brahmi, mandaic, sogdian, soyombo, phags-pa, math, telugu, chakma, symbols, limbu, balinese, mongolian, miao, meetei-mayek, sundanese, duployan, caucasian-albanian, kayah-li, bassa-vah, new-tai-lue, old-permic, malayalam, coptic, nko, hanunoo, tagalog, siddham, psalter-pahlavi
...
Your font fully covers the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Dutch (Latn, 31,709,104 speakers), Navajo (Latn, 166,319 speakers), Avokaya (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Koonzime (Latn, 40,000 speakers), Basaa (Latn, 332,940 speakers), Belarusian (Cyrl, 10,064,517 speakers), Dan (Latn, 1,099,244 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers), Ukrainian (Cyrl, 29,273,587 speakers). [code: soft-dotted]

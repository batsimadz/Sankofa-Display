 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, syriac, malayalam, tai-le, math, canadian-aboriginal, old-permic, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: khojki, nko, phags-pa, kayah-li, mahajani, bhaiksuki, adlam, tibetan, bengali, manichaean, sundanese, siddham, thai, lao, tamil, khudawadi, new-tai-lue, caucasian-albanian, modi, tagalog, psalter-pahlavi, takri, rejang, hanunoo, newa, thaana, buginese, dogra, grantha, mende-kikakui, music, old-permic, buhid, mongolian, telugu, batak, kaithi, tirhuta, sharada, ahom, oriya, tai-viet, cham, gurmukhi, syloti-nagri, miao, elbasan, devanagari, meetei-mayek, sogdian, gunjala-gondi, tagbanwa, limbu, myanmar, kannada, lepcha, masaram-gondi, bassa-vah, chakma, gujarati, tifinagh, marchen, javanese, mandaic, brahmi, pahawh-hmong, sinhala, syriac, balinese, duployan, zanabazar-square, tai-le, soyombo, malayalam, hebrew, wancho, math, symbols, osage, kharoshthi, coptic, khmer, hanifi-rohingya, yi
...
Your font fully covers the following languages that require the soft-dotted feature: Navajo (Latn, 166,319 speakers), Ebira (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers), Avokaya (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Dutch (Latn, 31,709,104 speakers), Ejagham (Latn, 120,000 speakers), Lithuanian (Latn, 2,357,094 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Basaa (Latn, 332,940 speakers), Nateni (Latn, 100,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Aghem (Latn, 38,843 speakers), Kom (Latn, 360,685 speakers), Koonzime (Latn, 40,000 speakers), Dan (Latn, 1,099,244 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

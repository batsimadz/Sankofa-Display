 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, math, tai-le, canadian-aboriginal, malayalam, tifinagh, coptic, old-permic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: modi, elbasan, cham, buginese, newa, meetei-mayek, bhaiksuki, new-tai-lue, khmer, tibetan, kharoshthi, marchen, nko, gurmukhi, malayalam, tagalog, bassa-vah, mandaic, balinese, duployan, bengali, kaithi, mende-kikakui, devanagari, phags-pa, syriac, music, buhid, sundanese, sharada, psalter-pahlavi, tamil, kayah-li, grantha, gujarati, tai-viet, lepcha, coptic, sogdian, javanese, old-permic, soyombo, syloti-nagri, chakma, mahajani, limbu, osage, adlam, tagbanwa, myanmar, thaana, rejang, wancho, hebrew, siddham, khojki, telugu, oriya, batak, hanunoo, brahmi, mongolian, math, pahawh-hmong, lao, zanabazar-square, manichaean, thai, caucasian-albanian, dogra, miao, tirhuta, symbols, masaram-gondi, tai-le, gunjala-gondi, khudawadi, hanifi-rohingya, ahom, yi, takri, sinhala, tifinagh, kannada
...
Your font fully covers the following languages that require the soft-dotted feature: Dutch (Latn, 31,709,104 speakers), Ejagham (Latn, 120,000 speakers), Avokaya (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Lithuanian (Latn, 2,357,094 speakers), Ma’di (Latn, 584,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Kom (Latn, 360,685 speakers), Basaa (Latn, 332,940 speakers), Belarusian (Cyrl, 10,064,517 speakers), Aghem (Latn, 38,843 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Koonzime (Latn, 40,000 speakers), Nateni (Latn, 100,000 speakers). [code: soft-dotted]

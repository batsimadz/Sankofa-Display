 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, old-permic, tifinagh, syriac, coptic, tai-le, math, malayalam
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: devanagari, takri, mandaic, gurmukhi, bassa-vah, manichaean, lao, music, ahom, osage, caucasian-albanian, javanese, tirhuta, mahajani, sundanese, zanabazar-square, oriya, myanmar, lepcha, duployan, new-tai-lue, limbu, tagalog, khojki, rejang, hanunoo, brahmi, khmer, nko, adlam, syloti-nagri, chakma, grantha, buginese, meetei-mayek, miao, bhaiksuki, tagbanwa, marchen, khudawadi, sharada, newa, pahawh-hmong, hanifi-rohingya, kannada, kayah-li, psalter-pahlavi, tifinagh, hebrew, tibetan, dogra, thaana, buhid, kaithi, wancho, syriac, coptic, yi, tamil, gunjala-gondi, sogdian, old-permic, tai-viet, bengali, masaram-gondi, elbasan, phags-pa, modi, malayalam, gujarati, cham, mende-kikakui, tai-le, soyombo, siddham, sinhala, kharoshthi, batak, telugu, mongolian, balinese, symbols, thai, math
...
Your font fully covers the following languages that require the soft-dotted feature: Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ejagham (Latn, 120,000 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Dutch (Latn, 31,709,104 speakers), Avokaya (Latn, 100,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Koonzime (Latn, 40,000 speakers), Basaa (Latn, 332,940 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Kom (Latn, 360,685 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

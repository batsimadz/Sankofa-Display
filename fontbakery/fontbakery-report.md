 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, math, canadian-aboriginal, syriac, coptic, tai-le, tifinagh, old-permic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: thaana, sharada, zanabazar-square, tai-le, tirhuta, masaram-gondi, elbasan, mongolian, cham, phags-pa, pahawh-hmong, mandaic, kaithi, mahajani, gurmukhi, sundanese, soyombo, chakma, osage, tagalog, buginese, duployan, khmer, lepcha, syriac, newa, siddham, modi, thai, buhid, hanunoo, tagbanwa, takri, kannada, ahom, telugu, lao, kayah-li, grantha, javanese, coptic, bhaiksuki, tifinagh, kharoshthi, nko, math, sinhala, manichaean, adlam, rejang, dogra, devanagari, gujarati, wancho, tai-viet, music, hebrew, balinese, psalter-pahlavi, bengali, old-permic, brahmi, yi, marchen, miao, new-tai-lue, syloti-nagri, meetei-mayek, tibetan, khojki, myanmar, mende-kikakui, malayalam, gunjala-gondi, oriya, bassa-vah, khudawadi, sogdian, batak, hanifi-rohingya, caucasian-albanian, tamil, symbols, limbu
...
Your font fully covers the following languages that require the soft-dotted feature: Lugbara (Latn, 2,200,000 speakers), Cicipu (Latn, 44,000 speakers), Southern Kisi (Latn, 360,000 speakers), Zapotec (Latn, 490,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Fur (Latn, 1,230,163 speakers), Nzakara (Latn, 50,000 speakers), Igbo (Latn, 27,823,640 speakers), Dutch (Latn, 31,709,104 speakers), Navajo (Latn, 166,319 speakers), Avokaya (Latn, 100,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Ekpeye (Latn, 226,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ma’di (Latn, 584,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Mundani (Latn, 34,000 speakers), Nateni (Latn, 100,000 speakers), Dii (Latn, 71,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Bafut (Latn, 158,146 speakers), Sar (Latn, 500,000 speakers), Yala (Latn, 200,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ejagham (Latn, 120,000 speakers), Basaa (Latn, 332,940 speakers), Koonzime (Latn, 40,000 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Dan (Latn, 1,099,244 speakers), Makaa (Latn, 221,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Gulay (Latn, 250,478 speakers), Kom (Latn, 360,685 speakers), South Central Banda (Latn, 244,000 speakers), Mango (Latn, 77,000 speakers). [code: soft-dotted]

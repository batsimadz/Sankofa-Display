 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, old-permic, canadian-aboriginal, syriac, tai-le, malayalam, tifinagh, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: bassa-vah, nko, kannada, tirhuta, kharoshthi, hebrew, khmer, tai-tham, gujarati, buhid, armenian, bhaiksuki, khudawadi, coptic, tai-viet, tagbanwa, new-tai-lue, hanunoo, buginese, tamil, osage, lao, malayalam, zanabazar-square, tagalog, sogdian, javanese, siddham, mende-kikakui, khojki, masaram-gondi, yi, phags-pa, limbu, old-permic, sundanese, tai-le, takri, manichaean, bengali, newa, lepcha, music, mongolian, math, soyombo, rejang, mandaic, tibetan, elbasan, sinhala, modi, kaithi, symbols, dogra, chakma, adlam, saurashtra, devanagari, mahajani, gurmukhi, warang-citi, cham, syriac, sharada, thaana, ahom, kayah-li, meetei-mayek, miao, gunjala-gondi, canadian-aboriginal, marchen, balinese, psalter-pahlavi, duployan, telugu, tifinagh, grantha, oriya, batak, caucasian-albanian, myanmar, wancho, brahmi, syloti-nagri, thai, hanifi-rohingya, pahawh-hmong
...
Your font fully covers the following languages that require the soft-dotted feature: Dutch (Latn, 31,709,104 speakers), Zapotec (Latn, 490,000 speakers), Cicipu (Latn, 44,000 speakers), Ma’di (Latn, 584,000 speakers), Igbo (Latn, 27,823,640 speakers), Avokaya (Latn, 100,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Lugbara (Latn, 2,200,000 speakers), Ebira (Latn, 2,200,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Nzakara (Latn, 50,000 speakers), Ekpeye (Latn, 226,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Mfumte (Latn, 79,000 speakers), Aghem (Latn, 38,843 speakers), South Central Banda (Latn, 244,000 speakers), Dii (Latn, 71,000 speakers), Nateni (Latn, 100,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Sar (Latn, 500,000 speakers), Ejagham (Latn, 120,000 speakers), Southern Kisi (Latn, 360,000 speakers), Bafut (Latn, 158,146 speakers), Mundani (Latn, 34,000 speakers), Makaa (Latn, 221,000 speakers), Gulay (Latn, 250,478 speakers), Ngbaka (Latn, 1,020,000 speakers), Basaa (Latn, 332,940 speakers), Mango (Latn, 77,000 speakers), Dan (Latn, 1,099,244 speakers), Kom (Latn, 360,685 speakers), Yala (Latn, 200,000 speakers), Koonzime (Latn, 40,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Belarusian (Cyrl, 10,064,517 speakers). [code: soft-dotted]

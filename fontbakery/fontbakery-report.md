 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, malayalam, coptic, old-permic, canadian-aboriginal, tai-le, tifinagh, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: meetei-mayek, buginese, new-tai-lue, sundanese, coptic, kharoshthi, duployan, lao, music, symbols, oriya, thaana, math, warang-citi, siddham, limbu, gujarati, tai-tham, bhaiksuki, tirhuta, mongolian, soyombo, pahawh-hmong, syloti-nagri, hanifi-rohingya, kayah-li, buhid, malayalam, nko, psalter-pahlavi, cham, dogra, bassa-vah, gurmukhi, tifinagh, tibetan, kaithi, lepcha, zanabazar-square, javanese, yi, modi, armenian, batak, balinese, tai-le, osage, sinhala, adlam, khojki, thai, syriac, sharada, mahajani, devanagari, gunjala-gondi, kannada, hanunoo, brahmi, marchen, elbasan, masaram-gondi, saurashtra, takri, old-permic, canadian-aboriginal, tagalog, mende-kikakui, rejang, khmer, wancho, tai-viet, miao, tagbanwa, bengali, caucasian-albanian, khudawadi, telugu, ahom, mandaic, tamil, sogdian, manichaean, chakma, grantha, hebrew, myanmar, newa, phags-pa
...
Your font fully covers the following languages that require the soft-dotted feature: Bete-Bendi (Latn, 100,000 speakers), Avokaya (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers), Ebira (Latn, 2,200,000 speakers), Cicipu (Latn, 44,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ekpeye (Latn, 226,000 speakers), Fur (Latn, 1,230,163 speakers), Lithuanian (Latn, 2,357,094 speakers), Zapotec (Latn, 490,000 speakers), Dutch (Latn, 31,709,104 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Bafut (Latn, 158,146 speakers), South Central Banda (Latn, 244,000 speakers), Dan (Latn, 1,099,244 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mundani (Latn, 34,000 speakers), Nateni (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Yala (Latn, 200,000 speakers), Sar (Latn, 500,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mfumte (Latn, 79,000 speakers), Koonzime (Latn, 40,000 speakers), Kom (Latn, 360,685 speakers), Gulay (Latn, 250,478 speakers), Mango (Latn, 77,000 speakers), Aghem (Latn, 38,843 speakers), Ejagham (Latn, 120,000 speakers), Basaa (Latn, 332,940 speakers), Ngbaka (Latn, 1,020,000 speakers), Southern Kisi (Latn, 360,000 speakers), Dii (Latn, 71,000 speakers). [code: soft-dotted]

 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, syriac, math, old-permic, tai-le, malayalam, coptic, tifinagh
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: yi, marchen, batak, gurmukhi, newa, osage, tibetan, ahom, syloti-nagri, tamil, thaana, hanunoo, zanabazar-square, bassa-vah, khmer, takri, wancho, brahmi, sharada, malayalam, tifinagh, new-tai-lue, phags-pa, saurashtra, miao, tai-le, armenian, sogdian, gunjala-gondi, hebrew, grantha, limbu, siddham, syriac, dogra, kayah-li, oriya, myanmar, mandaic, thai, psalter-pahlavi, soyombo, balinese, old-permic, buginese, nko, duployan, mongolian, modi, mahajani, telugu, warang-citi, sinhala, canadian-aboriginal, tai-viet, cham, tai-tham, tagalog, bhaiksuki, pahawh-hmong, buhid, sundanese, elbasan, kannada, chakma, kharoshthi, lao, devanagari, math, kaithi, javanese, symbols, manichaean, khojki, bengali, rejang, mende-kikakui, meetei-mayek, tagbanwa, music, khudawadi, caucasian-albanian, coptic, tirhuta, adlam, gujarati, lepcha, masaram-gondi, hanifi-rohingya
...
Your font fully covers the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Igbo (Latn, 27,823,640 speakers), Navajo (Latn, 166,319 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Ma’di (Latn, 584,000 speakers), Fur (Latn, 1,230,163 speakers), Bete-Bendi (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Zapotec (Latn, 490,000 speakers), Cicipu (Latn, 44,000 speakers), Ekpeye (Latn, 226,000 speakers), Nzakara (Latn, 50,000 speakers), Avokaya (Latn, 100,000 speakers), Dutch (Latn, 31,709,104 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Sar (Latn, 500,000 speakers), Ejagham (Latn, 120,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Southern Kisi (Latn, 360,000 speakers), Koonzime (Latn, 40,000 speakers), Mango (Latn, 77,000 speakers), Basaa (Latn, 332,940 speakers), Dan (Latn, 1,099,244 speakers), Aghem (Latn, 38,843 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mundani (Latn, 34,000 speakers), Mfumte (Latn, 79,000 speakers), Makaa (Latn, 221,000 speakers), Dii (Latn, 71,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), South Central Banda (Latn, 244,000 speakers), Kom (Latn, 360,685 speakers), Yala (Latn, 200,000 speakers), Gulay (Latn, 250,478 speakers), Bafut (Latn, 158,146 speakers), Nateni (Latn, 100,000 speakers). [code: soft-dotted]

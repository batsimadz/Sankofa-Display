 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, canadian-aboriginal, tifinagh, tai-le, math, malayalam, syriac, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: takri, new-tai-lue, mahajani, hebrew, yi, mandaic, marchen, coptic, kaithi, sharada, siddham, symbols, masaram-gondi, devanagari, duployan, brahmi, adlam, oriya, zanabazar-square, syloti-nagri, khudawadi, bassa-vah, grantha, syriac, gunjala-gondi, modi, bengali, newa, limbu, hanifi-rohingya, miao, ahom, sinhala, kayah-li, nko, tai-viet, rejang, thai, psalter-pahlavi, khojki, buhid, wancho, lao, kannada, tifinagh, tirhuta, hanunoo, kharoshthi, tibetan, meetei-mayek, soyombo, khmer, myanmar, pahawh-hmong, tagbanwa, javanese, tai-le, tagalog, dogra, music, elbasan, phags-pa, lepcha, malayalam, mende-kikakui, mongolian, bhaiksuki, math, buginese, sundanese, gujarati, batak, manichaean, sogdian, osage, gurmukhi, tamil, old-permic, thaana, telugu, cham, caucasian-albanian, chakma, balinese
...
Your font fully covers the following languages that require the soft-dotted feature: Ma’di (Latn, 584,000 speakers), Navajo (Latn, 166,319 speakers), Ejagham (Latn, 120,000 speakers), Dutch (Latn, 31,709,104 speakers), Igbo (Latn, 27,823,640 speakers), Lithuanian (Latn, 2,357,094 speakers), Avokaya (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Lugbara (Latn, 2,200,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Basaa (Latn, 332,940 speakers), Koonzime (Latn, 40,000 speakers), Aghem (Latn, 38,843 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Nateni (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers), Belarusian (Cyrl, 10,064,517 speakers), Dan (Latn, 1,099,244 speakers). [code: soft-dotted]

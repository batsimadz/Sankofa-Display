 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, tai-le, canadian-aboriginal, malayalam, syriac, coptic, tifinagh, old-permic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: newa, wancho, mandaic, soyombo, bhaiksuki, bassa-vah, siddham, phags-pa, kaithi, mongolian, hanifi-rohingya, symbols, yi, rejang, tibetan, tagbanwa, lao, caucasian-albanian, gujarati, nko, gurmukhi, tai-viet, hanunoo, oriya, balinese, zanabazar-square, coptic, ahom, grantha, sharada, sinhala, syloti-nagri, adlam, thai, kannada, buginese, devanagari, khmer, hebrew, elbasan, limbu, chakma, kayah-li, pahawh-hmong, syriac, meetei-mayek, sundanese, music, takri, dogra, duployan, myanmar, gunjala-gondi, thaana, marchen, brahmi, bengali, tagalog, old-permic, math, manichaean, khudawadi, miao, osage, lepcha, psalter-pahlavi, batak, malayalam, sogdian, kharoshthi, mahajani, tifinagh, mende-kikakui, tai-le, cham, modi, khojki, javanese, tamil, tirhuta, buhid, telugu, new-tai-lue, masaram-gondi
...
Your font fully covers the following languages that require the soft-dotted feature: Ijo, Southeast (Latn, 2,471,000 speakers), Nzakara (Latn, 50,000 speakers), Navajo (Latn, 166,319 speakers), Igbo (Latn, 27,823,640 speakers), Southern Kisi (Latn, 360,000 speakers), Cicipu (Latn, 44,000 speakers), Ma’di (Latn, 584,000 speakers), Fur (Latn, 1,230,163 speakers), Bete-Bendi (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Dutch (Latn, 31,709,104 speakers), Lithuanian (Latn, 2,357,094 speakers), Ebira (Latn, 2,200,000 speakers), Zapotec (Latn, 490,000 speakers), Ekpeye (Latn, 226,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: Dii (Latn, 71,000 speakers), Ejagham (Latn, 120,000 speakers), Sar (Latn, 500,000 speakers), Basaa (Latn, 332,940 speakers), South Central Banda (Latn, 244,000 speakers), Nateni (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers), Dan (Latn, 1,099,244 speakers), Kom (Latn, 360,685 speakers), Mfumte (Latn, 79,000 speakers), Aghem (Latn, 38,843 speakers), Mundani (Latn, 34,000 speakers), Makaa (Latn, 221,000 speakers), Koonzime (Latn, 40,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Bafut (Latn, 158,146 speakers), Yala (Latn, 200,000 speakers), Gulay (Latn, 250,478 speakers), Ngbaka (Latn, 1,020,000 speakers). [code: soft-dotted]

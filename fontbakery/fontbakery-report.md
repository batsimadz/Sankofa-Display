 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, tai-le, tifinagh, old-permic, syriac, malayalam, coptic, math
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: gujarati, yi, tibetan, phags-pa, modi, gurmukhi, sharada, kharoshthi, mongolian, thai, gunjala-gondi, ahom, miao, takri, grantha, mahajani, hanunoo, tagbanwa, lao, lepcha, myanmar, syriac, telugu, buhid, thaana, cham, music, tifinagh, kannada, kaithi, sogdian, balinese, batak, adlam, marchen, manichaean, kayah-li, khudawadi, tirhuta, math, masaram-gondi, nko, javanese, siddham, hebrew, brahmi, khojki, meetei-mayek, malayalam, wancho, mandaic, dogra, zanabazar-square, oriya, psalter-pahlavi, tamil, tagalog, soyombo, new-tai-lue, tai-viet, tai-le, pahawh-hmong, coptic, bhaiksuki, newa, old-permic, sinhala, osage, rejang, caucasian-albanian, sundanese, chakma, duployan, syloti-nagri, mende-kikakui, elbasan, bassa-vah, limbu, devanagari, bengali, khmer, symbols, hanifi-rohingya, buginese
...
Your font fully covers the following languages that require the soft-dotted feature: Igbo (Latn, 27,823,640 speakers), Cicipu (Latn, 44,000 speakers), Ma’di (Latn, 584,000 speakers), Fur (Latn, 1,230,163 speakers), Bete-Bendi (Latn, 100,000 speakers), Southern Kisi (Latn, 360,000 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Nzakara (Latn, 50,000 speakers), Avokaya (Latn, 100,000 speakers), Dutch (Latn, 31,709,104 speakers), Zapotec (Latn, 490,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ebira (Latn, 2,200,000 speakers), Ekpeye (Latn, 226,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers). 

Your font does *not* cover the following languages that require the soft-dotted feature: South Central Banda (Latn, 244,000 speakers), Basaa (Latn, 332,940 speakers), Bafut (Latn, 158,146 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Sar (Latn, 500,000 speakers), Dan (Latn, 1,099,244 speakers), Nateni (Latn, 100,000 speakers), Dii (Latn, 71,000 speakers), Mundani (Latn, 34,000 speakers), Mango (Latn, 77,000 speakers), Aghem (Latn, 38,843 speakers), Makaa (Latn, 221,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Koonzime (Latn, 40,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Kom (Latn, 360,685 speakers), Mfumte (Latn, 79,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Yala (Latn, 200,000 speakers), Ejagham (Latn, 120,000 speakers), Gulay (Latn, 250,478 speakers). [code: soft-dotted]
